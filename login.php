...
<head>
    ...
    <title>Login Administrator | Aplikasi Pemantauan Keuangan terkait Perjalanan Dinas</title>
    ...
    <div class="error-pagewrap">
        <div class="error-page-int">
            <div class="text-center m-b-md custom-login">
                <h3>Si paling SPD</h3>
                <h4>Aplikasi Pemantauan Keuangan terkait Perjalanan Dinas</h4>
                        ...
                        <form action="periksa_login.php" method="POST" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="akses">
                                    <option value="petugas">Petugas PPK</option>
                                    <option value="petugas_kepegawaian">Petugas Kepegawaian</option>
                                </select>
            ...
            <div class="text-center login-footer">
                <p class="text-muted">Copyright © <?php echo date('Y') ?>. All rights reserved.Aplikasi Pemantauan Keuangan terkait Perjalanan Dinas(Si paling SPD)</p>
            </div>
        </div>   
    </div>
