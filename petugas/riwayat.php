        ...
        <div class="panel-body">
            ...
            <table id="table" class="table table-bordered table-striped table-hover table-datatable">
                ...
                <tbody>
                    ...
                    $no = 1;
                    $saya = $_SESSION['id'];
                    $arsip = mysqli_query($koneksi,"SELECT * FROM riwayat,arsip_npwp,user WHERE riwayat_arsip=arsipp_id and riwayat_user=user_id and arsipp_petugas='$saya' ORDER BY riwayat_id DESC");
