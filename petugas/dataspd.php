...
<div class="breadcome-area">
    <div class="container-fluid" style="width:1900px;">
        <div class="row">
                ...
                <tbody>
                   ...
                   function query($query){
                    ...
                    if(isset($_GET["filter"])){
                        ...
                        $spd = mysqli_query($koneksi, "SELECT * FROM tabel_spd WHERE status_file='selesai' and file1 != '' and file2 != '' and file3 != '' and status_verif='Menunggu Verificator' order by spd_id ASC");
...
<div class="footer-copyright-area mg-t-30" style="width:1900px;">
