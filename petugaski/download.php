...
$keterangan = "Proses Pengecekan KI";
         ...
         if(isset($post) and count($post) > 0) {   //memeriksa file yang dipilih
             ...
             $zip = new ZipArchive(); // Load zip library  
              ...
              if(file_exists($zip_name))  {  // Unduh Zip 
                   ...
                   $stampki = mysqli_query($koneksi, "UPDATE tabel_spd SET stampki='$waktu' where spd_id='$id_spd'")or die(mysqli_error($koneksi));
                   $stempacctolak = mysqli_query($koneksi, "INSERT into stamp_acctolak values (NULL,'$user','$')")or die(mysqli_error($koneksi));
