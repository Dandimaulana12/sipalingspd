            ...
            <table id="table" class="table table-bordered table-striped table-hover table-datatable">
                ...
                <tbody>
                   ...
                   function query($query){
                    ...
                    $user = $_SESSION['id']; 
                    $spd = mysqli_query($koneksi,"SELECT * FROM tabel_spd where status='PNS' and file1 !='' and file2 != '' and file3 !=''");
                    $spdnon = mysqli_query($koneksi,"SELECT * FROM tabel_spd where status='Non-PNS' and file1 !='' and file2 != ''");
                    ...
                    ?>
                        <tr>
                            ...
                            <div class="btn-group">
                                <a href="data_file.php?idspd=<?php echo $pickidspd;?>" class="btn btn-default">Lihat</a>
                            </div>
...
?>        
                    ...
                    ?>
                    <?php
                    while ($p = mysqli_fetch_array($spdnon)){
                    $pickidspd = $p["spd_id"];
