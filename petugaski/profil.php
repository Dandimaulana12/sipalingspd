    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <?php 
                $id = $_SESSION['id'];
                $saya = mysqli_query($koneksi,"select * from petugas_ki where id_ki='$id'");
                ...
                <div class="single-cards-item">
                    ...
                    <div class="single-product-text">
                        ...
                        if($s['foto'] == ""){
                            ...
                            ?>
                            <img class="img-user" src="../gambar/petugas/<?php echo $s['foto']; ?>">
                            <?php
                        }
                        ?>
                    ...
                    <div class="panel-body">
                        ...
                        <form action="profil_act.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>Nama</label>
                                <input type="text" class="form-control" placeholder="Masukkan Nama .." name="nama" required="required" value="<?php echo $s['nama'] ?>">
                            </div>

                            <div class="form-group">
                                <label>Username</label>
                                <input type="text" class="form-control" placeholder="Masukkan Username .." name="username" required="required" value="<?php echo $s['username_ki'] ?>">
                            </div>
