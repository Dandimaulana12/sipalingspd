            ...
            <div class="left-custom-menu-adp-wrap comment-scrollbar">
                ...
                <nav class="sidebar-nav left-sidebar-menu-pro" style="margin-top: 30px">
                    ...
                    <ul class="metismenu" id="menu1">
                        ...
                        <li>
                            <a href="dataspdki.php" aria-expanded="false"><span class="educate-icon educate-professor icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Data SPD</span></a>
                        </li>
                                        ...
                                        <div class="header-right-info">
                                            ...
                                            <li class="nav-item">
                                                <a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle">
                                                    ...
                                                    $profil = mysqli_query($koneksi,"select * from petugas_ki where id_ki='$id_petugas'");
                                                    $profil = mysqli_fetch_assoc($profil);
                                                    if($profil['foto'] == ""){ 
                                                      ?>
                                                      <img src="../gambar/sistem/user.png" style="width: 20px;height: 20px">
                                                  <?php }else{ ?>
                                                    <img src="../gambar/petugas/<?php echo $profil['foto'] ?>" style="width: 20px;height: 20px">
                                                <?php } ?>
