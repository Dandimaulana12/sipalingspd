        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                <div class="white-box analytics-info-cs res-mg-t-30 table-mg-t-pro-n">
                    <h3 class="box-title">Total Menunggu Pembayaran</h3>
                    <ul class="list-inline two-part-sp">
                        <li>
                        ...
                        <li class="text-right graph-two-ctn">
                            ...
                            <span class="counter text-purple">
                                <?php 
                                $null = "";
                                $jumlah_user = mysqli_query($koneksi,"SELECT * from tabel_spd where status_admin='Menunggu Admin' and status_file='selesai' and file1 != '$null' and file2 != '$null' and file3 != '$null'");
                                ?>
